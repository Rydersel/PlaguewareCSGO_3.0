...
struct Config 
{
	...
	struct shonax_add
	{
		bool chams_on_shot_enable;
		int chams_on_shot_type;
		Color chams_on_shot_color;

		bool autostop_fixer;
		bool hitchance_fixer;
	...
	struct esp_conf
	{
		...
		bool nade_esp;
		Color color, impacts_color, nade_color, ammo_color, name_color, box_color, skeleton_color, local_impacts_color, radar_color, weapon_color;
		...
		Color show_lag_compensation_color;
		bool show_on_shot_hitboxes;
		bool grenade_pred;
		Color grenade_predc; int grenade_preds;
		float local_impact_width;
		bool hitmarker_damage;
		bool multipoint;

		// styling
		bool health_based; Color health_color; int health_dividers;
		bool armor; Color armor_color;
		bool wep_icons;

		Color esp_color_e, esp_color_t;
		int health_bar_t;
		int skeleton_e_t;
		int out_of_fov_e_t;
		int chams_e_t;
