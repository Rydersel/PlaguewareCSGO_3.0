...
void __fastcall hooks::hooked_sceneend(void* ecx, void* edx)
{
	...
	for (auto i = 1; i <= m_entitylist()->GetHighestEntityIndex(); i++)
	{
		...
		{
			m_materialsystem()->FindMaterial(crypt_str("SHONAX-PROJECT_chams"), nullptr), //-V807
			m_materialsystem()->FindMaterial(crypt_str("SHONAX-PROJECT_metallic"), nullptr),
			m_materialsystem()->FindMaterial(crypt_str("SHONAX-PROJECT_flat"), nullptr),
			...
			m_materialsystem()->FindMaterial(crypt_str("SHONAX-PROJECT_glow"), nullptr)
		};
