...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonEx_c(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0, int align = 0);
    ...
    IMGUI_API bool          BlssButtonXD(const char* label, const ImVec2& size_arg, bool inuse, ImGuiWindowFlags flags);
    IMGUI_API bool          BlssButton(const char* label, bool inuse, const ImVec2& size_arg);
    ...
    // Debug Tools
    inline void             DebugDrawItemRect(ImU32 col = IM_COL32(69, 7, 184, 255)) { ImGuiContext& g = *GImGui; ImGuiWindow* window = g.CurrentWindow; GetForegroundDrawList(window)->AddRect(window->DC.LastItemRect.Min, window->DC.LastItemRect.Max, col); }
