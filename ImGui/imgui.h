...
enum ImGuiColorEditFlags_
{
    ...
    ImGuiColorEditFlags_NoInputs = 1 << 5,   //              // ColorEdit, ColorPicker: disable inputs /text widgets (e.g. to show only the small preview colored square).
...
#define IM_COL32_WHITE       IM_COL32(69, 7, 184,255)  // Opaque white = 0xFFFFFFFF
